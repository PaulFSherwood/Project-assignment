...
INSERT INTO `Logistics` VALUES (11,'ADI',10,'51c',200,3,'123-ABC','Sample Note 1',20,'Vendor1','123','456','789','Electrical','Vendor1','2023-01-01',1),(12,'MFD',10,'55a',250,3,'456-DEF','Sample Note 2',30,'Vendor2','456','789','012','Electrical','Vendor2','2023-01-02',2),(13,'HSI',10,'53c',150,3,'789-GHI','Sample Note 3',15,'Vendor3','789','012','345','Electrical','Vendor3','2023-01-03',3),(14,'Windscreen',10,'54b',300,3,'012-JKL','Sample Note 4',25,'Vendor4','012','345','678','Electrical','Vendor4','2023-01-04',4),(15,'Battery',100,'100a',20,3,'123-ABC','Sample Note 5',2,'Vendor1','123','456','789','Electrical','Vendor1','2023-01-05',1),(16,'Bandaids',100,'101b',5,3,'456-DEF','Sample Note 6',1,'Vendor2','456','789','012','Hydraulic','Vendor2','2023-01-06',2),(17,'Screws',100,'102c',10,3,'789-GHI','Sample Note 7',1.5,'Vendor3','789','012','345','Hydraulic','Vendor3','2023-01-07',3),(18,'Tire',50,'1d',400,3,'012-JKL','Sample Note 8',40,'Vendor4','012','345','678','Hydraulic','Vendor4','2023-01-08',4),(19,'Landing Gear',50,'2a',1000,3,'123-ABC','Sample Note 9',100,'Vendor1','123','456','789','Hydraulic','Vendor1','2023-01-09',1),(20,'Aircraft Shell',50,'3d',5000,3,'456-DEF','Sample Note 10',500,'Vendor2','456','789','012','Hydraulic','Vendor2','2023-01-10',2),(21,'ADI',10,'51c',200,3,'123-ABC','Sample Note 1',20,'Vendor1','123','456','789','Electrical','Vendor1','2023-01-01',1),(22,'MFD',10,'55a',250,3,'456-DEF','Sample Note 2',30,'Vendor2','456','789','012','Electrical','Vendor2','2023-01-02',2),(23,'HSI',10,'53c',150,3,'789-GHI','Sample Note 3',15,'Vendor3','789','012','345','Electrical','Vendor3','2023-01-03',3),(24,'Windscreen',10,'54b',300,3,'012-JKL','Sample Note 4',25,'Vendor4','012','345','678','Electrical','Vendor4','2023-01-04',4),(25,'Battery',100,'100a',20,3,'123-ABC','Sample Note 5',2,'Vendor1','123','456','789','Electrical','Vendor1','2023-01-05',1),(26,'Bandaids',100,'101b',5,3,'456-DEF','Sample Note 6',1,'Vendor2','456','789','012','Hydraulic','Vendor2','2023-01-06',2),(27,'Screws',100,'102c',10,3,'789-GHI','Sample Note 7',1.5,'Vendor3','789','012','345','Hydraulic','Vendor3','2023-01-07',3),(28,'Tire',50,'1d',400,3,'012-JKL','Sample Note 8',40,'Vendor4','012','345','678','Hydraulic','Vendor4','2023-01-08',4),(29,'Landing Gear',50,'2a',1000,3,'123-ABC','Sample Note 9',100,'Vendor1','123','456','789','Hydraulic','Vendor1','2023-01-09',1),(30,'Aircraft Shell',50,'3d',5000,3,'456-DEF','Sample Note 10',500,'Vendor2','456','789','012','Hydraulic','Vendor2','2023-01-10',2);
...
CREATE TABLE `WorkOrder_Missions` (
  ...
  CONSTRAINT `WorkOrder_Missions_ibfk_1` FOREIGN KEY (`jcn`) REFERENCES `WorkOrders` (`jcn`),
...
CREATE TABLE `WorkOrder_Parts` (
  ...
  KEY `jcn` (`jcn`),
  KEY `part_id` (`part_id`),
  CONSTRAINT `WorkOrder_Parts_ibfk_1` FOREIGN KEY (`jcn`) REFERENCES `WorkOrders` (`jcn`),
...
CREATE TABLE `WorkOrders` (
  `jcn` int NOT NULL AUTO_INCREMENT,
  `simulator_id` int DEFAULT NULL,
  `subsystem_id` int DEFAULT NULL,
...
INSERT INTO `WorkOrders` VALUES (81,1,1,'2023-06-12','2023-06-12',1,'Initial work order','Work order completed','Part1','2023-06-12',2,1,'maintenance','No additional notes',1,'AWM'),(82,2,2,'2023-01-01','2023-01-02',2,'Scheduled work order','Work order completed','Part2','2023-01-03',3,2,'maintenance','No additional notes',2,'AWM'),(83,3,3,'2023-02-01','2023-02-02',3,'Emergency work order','Work order completed','Part3','2023-02-03',4,3,'maintenance','No additional notes',3,'AWT'),(84,4,4,'2023-03-01','2023-03-02',4,'Regular work order','Work order completed','Part4','2023-03-03',5,1,'maintenance','No additional notes',4,'AWE'),(85,5,1,'2023-04-01','2023-04-02',1.5,'Unscheduled work order','Work order completed','Part5','2023-04-03',6,2,'maintenance','No additional notes',1.5,'AWM'),(86,6,2,'2023-05-01','2023-05-02',2.5,'Scheduled work order','Work order completed','Part6','2023-05-03',2,3,'maintenance','No additional notes',2.5,'AWT'),(87,1,3,'2023-06-01','2023-06-02',3.5,'Emergency work order','Work order completed','Part7','2023-06-03',3,1,'maintenance','No additional notes',3.5,'AWE'),(88,2,4,'2023-07-01','2023-07-02',4.5,'Regular work order','Work order completed','Part8','2023-07-03',4,2,'maintenance','No additional notes',4.5,'AWM'),(89,3,1,'2023-08-01','2023-08-02',1.75,'Unscheduled work order','Work order completed','Part9','2023-08-03',5,3,'maintenance','No additional notes',1.75,'AWT'),(90,4,2,'2023-09-01','2023-09-02',2.75,'Scheduled work order','Work order completed','Part10','2023-09-03',6,1,'maintenance','No additional notes',2.75,'AWE'),(91,5,3,'2023-06-12','2023-06-12',3.75,'Emergency work order','Work order completed','Part11','2023-10-03',2,2,'maintenance','No additional notes',3.75,'AWM');
...
-- Dump completed on 2023-06-12 23:37:04
